...
export const createTransactionSchema = z.object({
  accountId:           z.string().regex(objectIdRegex, 'Invalid ObjectId'),
...
// type is NOT updatable — define update schema explicitly to avoid
// .omit() on a superRefine schema (Zod v4 restriction).
